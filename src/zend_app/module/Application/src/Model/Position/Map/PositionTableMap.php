...
class PositionTableMap extends TableMap
{
     ...
     */
    const COL_ID = 'position.id';

    /**
     * the column name for the xpos field
     */
    const COL_XPOS = 'position.xpos';

    /**
     * the column name for the ypos field
     */
    const COL_YPOS = 'position.ypos';

    /**
     * the column name for the zpos field
     */
    const COL_ZPOS = 'position.zpos';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Xpos', 'Ypos', 'Zpos', ),
        self::TYPE_CAMELNAME     => array('id', 'xpos', 'ypos', 'zpos', ),
        self::TYPE_COLNAME       => array(PositionTableMap::COL_ID, PositionTableMap::COL_XPOS, PositionTableMap::COL_YPOS, PositionTableMap::COL_ZPOS, ),
        self::TYPE_FIELDNAME     => array('id', 'xpos', 'ypos', 'zpos', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Xpos' => 1, 'Ypos' => 2, 'Zpos' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'xpos' => 1, 'ypos' => 2, 'zpos' => 3, ),
        self::TYPE_COLNAME       => array(PositionTableMap::COL_ID => 0, PositionTableMap::COL_XPOS => 1, PositionTableMap::COL_YPOS => 2, PositionTableMap::COL_ZPOS => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'xpos' => 1, 'ypos' => 2, 'zpos' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('zpos', 'Zpos', 'INTEGER', true, null, null);
    } // initialize()
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PositionTableMap::COL_XPOS);
            $criteria->addSelectColumn(PositionTableMap::COL_YPOS);
            $criteria->addSelectColumn(PositionTableMap::COL_ZPOS);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.xpos');
            $criteria->addSelectColumn($alias . '.ypos');
            $criteria->addSelectColumn($alias . '.zpos');
        }
    }
