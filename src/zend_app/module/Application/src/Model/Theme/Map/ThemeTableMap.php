...
class ThemeTableMap extends TableMap
{
     ...
     */
    const COL_HEIGHT = 'theme.height';

    /**
     * the column name for the width field
     */
    const COL_WIDTH = 'theme.width';

    /**
     * the column name for the backgroundColor field
     */
    const COL_BACKGROUNDCOLOR = 'theme.backgroundColor';

    /**
     * the column name for the color field
     */
    const COL_COLOR = 'theme.color';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Height', 'Width', 'BackgroundColor', 'Color', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'height', 'width', 'backgroundColor', 'color', ),
        self::TYPE_COLNAME       => array(ThemeTableMap::COL_ID, ThemeTableMap::COL_NAME, ThemeTableMap::COL_HEIGHT, ThemeTableMap::COL_WIDTH, ThemeTableMap::COL_BACKGROUNDCOLOR, ThemeTableMap::COL_COLOR, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'height', 'width', 'backgroundColor', 'color', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Height' => 2, 'Width' => 3, 'BackgroundColor' => 4, 'Color' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'height' => 2, 'width' => 3, 'backgroundColor' => 4, 'color' => 5, ),
        self::TYPE_COLNAME       => array(ThemeTableMap::COL_ID => 0, ThemeTableMap::COL_NAME => 1, ThemeTableMap::COL_HEIGHT => 2, ThemeTableMap::COL_WIDTH => 3, ThemeTableMap::COL_BACKGROUNDCOLOR => 4, ThemeTableMap::COL_COLOR => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'height' => 2, 'width' => 3, 'backgroundColor' => 4, 'color' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('backgroundColor', 'BackgroundColor', 'VARCHAR', true, 128, null);
        $this->addColumn('color', 'Color', 'VARCHAR', true, 128, 'black');
    } // initialize()
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ThemeTableMap::COL_HEIGHT);
            $criteria->addSelectColumn(ThemeTableMap::COL_WIDTH);
            $criteria->addSelectColumn(ThemeTableMap::COL_BACKGROUNDCOLOR);
            $criteria->addSelectColumn(ThemeTableMap::COL_COLOR);
        } else {
