...
class NoteTableMap extends TableMap
{
     ...
     */
    const COL_CONTENT = 'note.content';

    /**
     * the column name for the theme_id field
     */
    const COL_THEME_ID = 'note.theme_id';

    /**
     * the column name for the position_id field
     */
    const COL_POSITION_ID = 'note.position_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Title', 'Content', 'ThemeId', 'PositionId', 'CreatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'title', 'content', 'themeId', 'positionId', 'createdAt', ),
        self::TYPE_COLNAME       => array(NoteTableMap::COL_ID, NoteTableMap::COL_TITLE, NoteTableMap::COL_CONTENT, NoteTableMap::COL_THEME_ID, NoteTableMap::COL_POSITION_ID, NoteTableMap::COL_CREATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'title', 'content', 'theme_id', 'position_id', 'created_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Title' => 1, 'Content' => 2, 'ThemeId' => 3, 'PositionId' => 4, 'CreatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'title' => 1, 'content' => 2, 'themeId' => 3, 'positionId' => 4, 'createdAt' => 5, ),
        self::TYPE_COLNAME       => array(NoteTableMap::COL_ID => 0, NoteTableMap::COL_TITLE => 1, NoteTableMap::COL_CONTENT => 2, NoteTableMap::COL_THEME_ID => 3, NoteTableMap::COL_POSITION_ID => 4, NoteTableMap::COL_CREATED_AT => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'title' => 1, 'content' => 2, 'theme_id' => 3, 'position_id' => 4, 'created_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('theme_id', 'ThemeId', 'INTEGER', 'theme', 'id', true, null, null);
        $this->addForeignKey('position_id', 'PositionId', 'INTEGER', 'position', 'id', true, null, null);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(NoteTableMap::COL_CONTENT);
            $criteria->addSelectColumn(NoteTableMap::COL_THEME_ID);
            $criteria->addSelectColumn(NoteTableMap::COL_POSITION_ID);
