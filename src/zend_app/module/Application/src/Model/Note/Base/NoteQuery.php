 ...
 * @method     ChildNoteQuery orderByContent($order = Criteria::ASC) Order by the content column
 * @method     ChildNoteQuery orderByThemeId($order = Criteria::ASC) Order by the theme_id column
 * @method     ChildNoteQuery orderByPositionId($order = Criteria::ASC) Order by the position_id column
 ...
 * @method     ChildNoteQuery groupByContent() Group by the content column
 * @method     ChildNoteQuery groupByThemeId() Group by the theme_id column
 * @method     ChildNoteQuery groupByPositionId() Group by the position_id column
 ...
 *
 * @method     ChildNoteQuery leftJoinTheme($relationAlias = null) Adds a LEFT JOIN clause to the query using the Theme relation
 * @method     ChildNoteQuery rightJoinTheme($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Theme relation
 * @method     ChildNoteQuery innerJoinTheme($relationAlias = null) Adds a INNER JOIN clause to the query using the Theme relation
 *
 * @method     ChildNoteQuery joinWithTheme($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Theme relation
 *
 * @method     ChildNoteQuery leftJoinWithTheme() Adds a LEFT JOIN clause and with to the query using the Theme relation
 * @method     ChildNoteQuery rightJoinWithTheme() Adds a RIGHT JOIN clause and with to the query using the Theme relation
 * @method     ChildNoteQuery innerJoinWithTheme() Adds a INNER JOIN clause and with to the query using the Theme relation
 *
 * @method     ChildNoteQuery leftJoinPosition($relationAlias = null) Adds a LEFT JOIN clause to the query using the Position relation
 * @method     ChildNoteQuery rightJoinPosition($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Position relation
 * @method     ChildNoteQuery innerJoinPosition($relationAlias = null) Adds a INNER JOIN clause to the query using the Position relation
 *
 * @method     ChildNoteQuery joinWithPosition($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Position relation
 *
 * @method     ChildNoteQuery leftJoinWithPosition() Adds a LEFT JOIN clause and with to the query using the Position relation
 ...
 * @method     ChildNote findOneByContent(string $content) Return the first ChildNote filtered by the content column
 * @method     ChildNote findOneByThemeId(int $theme_id) Return the first ChildNote filtered by the theme_id column
 * @method     ChildNote findOneByPositionId(int $position_id) Return the first ChildNote filtered by the position_id column
 ...
 * @method     ChildNote requireOneByContent(string $content) Return the first ChildNote filtered by the content column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildNote requireOneByThemeId(int $theme_id) Return the first ChildNote filtered by the theme_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildNote requireOneByPositionId(int $position_id) Return the first ChildNote filtered by the position_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildNote[]|ObjectCollection findByContent(string $content) Return ChildNote objects filtered by the content column
 * @method     ChildNote[]|ObjectCollection findByThemeId(int $theme_id) Return ChildNote objects filtered by the theme_id column
 * @method     ChildNote[]|ObjectCollection findByPositionId(int $position_id) Return ChildNote objects filtered by the position_id column
...
abstract class NoteQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id`, `title`, `content`, `theme_id`, `position_id`, `created_at` FROM `note` WHERE `id` = :p0';
        try {
    ...
    public function filterByContent($content = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(NoteTableMap::COL_CONTENT, $content, $comparison);
    }
    ...
    public function filterByThemeId($themeId = null, $comparison = null)
    {
        if (is_array($themeId)) {
            ...
            if (isset($themeId['min'])) {
                $this->addUsingAlias(NoteTableMap::COL_THEME_ID, $themeId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($themeId['max'])) {
                $this->addUsingAlias(NoteTableMap::COL_THEME_ID, $themeId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(NoteTableMap::COL_THEME_ID, $themeId, $comparison);
    }
    ...
    public function filterByPositionId($positionId = null, $comparison = null)
    {
        if (is_array($positionId)) {
            ...
            if (isset($positionId['min'])) {
                $this->addUsingAlias(NoteTableMap::COL_POSITION_ID, $positionId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($positionId['max'])) {
                $this->addUsingAlias(NoteTableMap::COL_POSITION_ID, $positionId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(NoteTableMap::COL_POSITION_ID, $positionId, $comparison);
    }
